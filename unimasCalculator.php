...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="/static/images/unimasLogo.png" alt="" width="125px;" style="margin-top:55px;">
      <h1>CGPA Calculator (Universiti Malaysia Sarawak)</h1>
    </div>
          ...
          <div class="two fields subject1" id="Subject">
            <div class="field" id="grade1">
              ...
              <select class="ui dropdown1" name="grade1" onchange="pFunction1()">
                ...
                <option value="1.50" <?php if (isset($grade) && $grade=="1.50") echo "checked";?>>C-</option>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Malaysia Sarawak (Unimas)</h3>
