...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="/static/images/upsiLogo.png" alt="" width="125px;" style="margin-top:55px;">
      <h1>CGPA Calculator (Universiti Pendidikan Sultan Idris)</h1>
    </div>
          ...
          <div class="two fields subject1" id="Subject">
            <div class="field" id="grade1">
              ...
              <select class="ui dropdown1" name="grade1" onchange="pFunction1()">
                ...
                <option value="3.40" <?php if (isset($grade) && $grade=="3.40") echo "checked";?>>B+</option>
                ...
                <option value="2.40" <?php if (isset($grade) && $grade=="2.40") echo "checked";?>>C+</option>
                ...
                <option value="1.40" <?php if (isset($grade) && $grade=="1.40") echo "checked";?>>D+</option>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Pendidikan Sultan Idris (UPSI)</h3>
